(function($) {
  ...
  var myRadarChart = new Chart(ctx4).PolarArea(data4, options4);
  ...
  var myPieChart = new Chart(ctx5).Pie(data5,options5);
  var ctx6 = document.getElementById('doughnutChart').getContext('2d');
  var myDoughnutChart = new Chart(ctx6).Doughnut(data5,options5);
