...
(function($, window, document, undefined) {
    ...
    $.extend(CubePortfolio.prototype, {
        ...
        computeFilter: function() {
            ...
            // filter call layout
            t.filterLayout(t.filterConcat(t.defaultFilter));
        },
        ...
        computeBlocks: function() {
            var t = this,
                filterName = t.filterConcat(t.defaultFilter);
        ...
        resizeMainContainer: function() {
            var t = this,
                height = t.freeSpaces.slice(-1)[0].topStart - t.options.gapHorizontal,
                maxWidth;
    ...
    Filters.prototype.registerFilter = function() {
        ...
        t.filters.each(function(index, el) {
            ...
            items.on('click.cbp', function() {
                ...
                // filter the items
                parent.$obj.cubeportfolio('filter', name.join('|'));
            });
        });
    };
    ...
    CubePortfolio.Public = {
        ...
        filter: function(filterName, callback) {
            ...
            if (t.options.filterDeeplinking) {
                ...
                location.href = url + '#cbpf=' + encodeURIComponent(filterName);
