...
(function($){
	...
	function getFeed(type,id,path,o,obj,opt,f1,f2,intro,feed,fn){
		...
		switch (type) {
			...
			url = url = cp.length > 1 ? 'https://graph.facebook.com/'+cp[1]+'/photos?fields=id,link,from,name,picture,images,comments&limit='+n : curl + '?id='+id+'&limit='+n;
			break;
			*/
			case 'facebook':
			var cp = id.split('/');
